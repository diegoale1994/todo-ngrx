...
export const BORRAR_TODO_TODO = '[TODO] Borrar todo todo';
...
export class BorrarAllTodoAction implements Action {
    readonly type = BORRAR_TODO_TODO;
}
...
export type Acciones = AgregarTodoAction | ToggleTodoAction |
                         EditarTodoAction | BorrarTodoAction | ToggleAllTodoAction | BorrarAllTodoAction;
